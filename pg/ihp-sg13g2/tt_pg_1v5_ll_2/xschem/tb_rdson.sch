...
N 80 80 90 80 {
lab=vdd}
C {tt_pg_1v5_ll_2.sym} 250 -120 0 0 {name=x1}
...
C {tt_pg_1v5_ll_2.sym} 250 80 0 0 {name=x2
schematic=tt_pg_1v5_ll_2_pex.sim
spice_sym_def="tcleval(.include [file normalize ../mag/tt_pg_1v5_ll_2.pex.spice])"
tclcommand="textwindow [file normalize ../mag/tt_pg_1v5_ll_2.pex.spice]"}
