...
S {}
E {}
T {Rough estimate of max capacitance
of 8x1 area filled with decap cells} 560 -120 0 0 0.2 0.2 {}
N 90 -120 100 -120 {
lab=#net1}
N 80 -370 80 -360 {
lab=vdd}
...
C {devices/vsource.sym} 80 -330 0 0 {name=V1 value=1.2 savecurrent=true}
...
C {devices/lab_pin.sym} 500 -160 0 1 {name=p1 sig_type=std_logic lab=vdd_dut
