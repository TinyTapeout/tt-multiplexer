...
C {sky130_fd_pr/pfet3_01v8.sym} 680 -580 3 0 {name=M3
W=1769
L=0.15
body=VPWR
nf=244
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 170 -380 0 0 {name=C1 model=cap_mim_m3_1 W=6.9 L=19.4 MF=1 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1130 -380 0 0 {name=C2 model=cap_mim_m3_1 W=6.9 L=19.4 MF=2 spiceprefix=X}
