...
N -40 -120 80 -120 {
lab=#net1}
N 400 -160 420 -160 {lab=#net2}
C {tt_pg_3v3_hp_2.sym} 250 -120 0 0 {name=x1}
...
tran 50p 5u
plot vdpwr_dut
plot vdpwr_dut x1.ctrl_n xlimit 50n 60n
*quit 0
.endc
.end
"}
...
C {devices/vsource.sym} 80 -330 0 0 {name=V1 value=3.3 savecurrent=true}
...
C {devices/lab_pin.sym} 500 -160 0 1 {name=p1 sig_type=std_logic lab=vdpwr_dut
...
C {devices/vsource.sym} -40 -90 0 1 {name=V2 value="PULSE(0 3.3 50n 0.5n 0.5n 99.5n 4u)" savecurrent=false}
