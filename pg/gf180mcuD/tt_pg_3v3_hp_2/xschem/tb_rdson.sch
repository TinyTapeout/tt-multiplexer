...
C {tt_pg_3v3_hp_2.sym} 250 80 0 0 {name=x2
schematic=tt_pg_3v3_hp_2_pex.sim
spice_sym_def="tcleval(.include [file normalize ../mag/tt_pg_3v3_hp_2.pex.spice])"
tclcommand="textwindow [file normalize ../mag/tt_pg_3v3_hp_2.pex.spice]"}
