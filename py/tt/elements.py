...
class Top(LayoutElement):
	...
	def __init__(self, layout, placer):
		...
		logo_corner = Logo(layout, 'corner_tl')
		self.add_child(logo_corner, Point(LayoutDimension(26000) - layout.glb.top.pos_x, LayoutDimension(5122000 - 190000) - layout.glb.top.pos_y), 'N', name='logo_corner_tl_I')

		logo_corner = Logo(layout, 'corner_tr')
		self.add_child(logo_corner, Point(LayoutDimension(3932000 - 246000) - layout.glb.top.pos_x, LayoutDimension(5122000 - 246000) - layout.glb.top.pos_y), 'N', name='logo_corner_tr_I')
