...
N 160 -30 320 -30 {
lab=mod}
C {tt_asw_5v0.sym} 10 -280 0 0 {name=x1}
...
C {devices/lab_pin.sym} -100 -560 2 1 {name=p5 sig_type=std_logic lab=VAPWR
}
C {devices/lab_pin.sym} 170 -300 2 0 {name=p6 sig_type=std_logic lab=VDPWR
}
...
C {devices/vsource.sym} 10 -520 0 0 {name=V3 value="PULSE(3.3 0 5n 0 0 10n 20n)" savecurrent=false}
C {devices/gnd.sym} 10 -480 0 0 {name=l4 lab=GND}
C {devices/lab_pin.sym} 10 -560 2 1 {name=p3 sig_type=std_logic lab=ctrl
}
C {devices/lab_pin.sym} 170 -320 2 0 {name=p7 sig_type=std_logic lab=VAPWR
}
C {devices/vsource.sym} -190 -520 0 0 {name=V1 value=3.3 savecurrent=false}
C {devices/gnd.sym} -190 -480 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} -190 -560 2 1 {name=p8 sig_type=std_logic lab=VDPWR
}
C {devices/lab_wire.sym} 320 -280 0 1 {name=p1 sig_type=std_logic lab=mod}
C {tt_asw_5v0.sym} 10 -30 0 0 {name=x2
schematic=tt_asw_5v0_pex.sim
spice_sym_def="tcleval(.include [file normalize ../mag/tt_asw_5v0.pex.spice])"
tclcommand="textwindow [file normalize ../mag/tt_asw_5v0.pex.spice]"
}
C {devices/lab_pin.sym} 170 -50 2 0 {name=p9 sig_type=std_logic lab=VDPWR
}
...
C {devices/lab_pin.sym} 170 -70 2 0 {name=p12 sig_type=std_logic lab=VAPWR
}
C {devices/lab_wire.sym} 320 -30 0 1 {name=p13 sig_type=std_logic lab=mod}
C {devices/code.sym} 330 -560 0 0 {name=TT_MODELS
only_toplevel=true
